  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight">
        <motion.div
          className="flex items-center justify-center border border-solid border-light rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer hover:border-dark hover:bg-light"
          whileHover={{ scale: 1.05 }}
        >
          Web
        </motion.div>
